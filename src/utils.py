...
def argument_setup():
    ...
    parser.add_argument('--task', type=str, choices=['mca', 'mcar', 'ca', 'car', 'ia', 'none', 'srwa', 'pga', 'rev', 'trial'], default='mca')
    parser.add_argument('--method', type=str, default='none')  
    parser.add_argument('--otask', type=str, choices=['ca', 'car', 'ia'], default=None)
    parser.add_argument('--omethod', type=str, choices=['bops', 'popular', 'random'], default=None)
    ...
    parser.add_argument('--adv_rounds', type=int, default=5)
    ...
    # specific parameters for consisrec model
